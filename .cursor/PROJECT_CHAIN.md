...
1. End-to-end: новий вчитель → клас → учень → пост → чат → завдання → перевірка.
2. За потреби: вчитель створює учнів вручну (1–2 клас).
3. Пізніше: PostgreSQL; websocket замість polling.
